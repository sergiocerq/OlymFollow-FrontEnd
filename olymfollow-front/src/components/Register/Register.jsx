...
const Register = () => {
    ...
    const { register, setRegister, showPassword, setShowPassword, handleSubmit , isInvalidPassword, setIsInvalidPassword, showConfirmationPassword, setShowConfirmationPassword} = useRegister();
          ...
          <div className="main-div-form-login">
            <form className="form">
              ...
              <div className="input-container">
                ...
                />
                <span>
                <svg fill="#adadad" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" stroke="#adadad"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M16 15.503A5.041 5.041 0 1 0 16 5.42a5.041 5.041 0 0 0 0 10.083zm0 2.215c-6.703 0-11 3.699-11 5.5v3.363h22v-3.363c0-2.178-4.068-5.5-11-5.5z"></path></g></svg>
                </span>
              </div>
              <div className="input-container">
                <input
              ...
              <div className="input-container">
                <input  className={(isInvalidPassword ? "invalid" : "")}                 
