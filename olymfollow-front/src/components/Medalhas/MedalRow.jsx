        ...
        >
          ...
          <div className="content">
            <span className="title">
              Deseja receber notificações quando {selectedCountry} ganhar
              medalhas?
            </span>
            <br />
            <br />
            <div className="actions">
              {!hasToken && (
                <div>
                  <a onClick={() => navigate("/login")} className="doLogin">
                    Fazer login
                  </a>
                </div>
              )}
              {hasToken && (
                <div>
                  <a onClick={() => subscribe()} className="unsubscribe">
                    Sim
                  </a>
                </div>
              )}
...
export const TableRow = (data) => {
  ...
  useEffect(() => {
    const getFillSVGMedal = () => {
      switch (data.medal.medalha) {
        case "OURO":
          setColorMedal("#FFD700");
          break;
        case "PRATA":
          setColorMedal("#C0C0C0");
          break;
        case "BRONZE":
          setColorMedal("#CD7F32");
          break;
        default:
          setColorMedal("#636363");
          break;
      }
    };
    getFillSVGMedal();
  ...
  return (
    <>
      <tr>
        ...
        <td style={{ padding: "20px" }}>{data.medal.nomeAtleta}</td>
